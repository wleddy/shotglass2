...
INSERT INTO user (first_name,last_name,email,username,active) VALUES ('inactive','user','inactive@example.com','inactive',0);
...
INSERT INTO user_role (user_id,role_id) VALUES (
    (select id from user where username = 'inactive'),
    (select id from role where name = 'user')
);
COMMIT;
